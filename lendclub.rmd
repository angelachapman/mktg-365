...
print(summary(pred2))
print(mean(pred2-validation$bad_standing))
...
# I know he did the following in class, but I personally think it's a biased way
# of looking at the logistic regression results
validation$pred2 = pred2
validation <- validation[!is.na(pred2),]
target <- validation[pred2>4*mean(pred2),]
